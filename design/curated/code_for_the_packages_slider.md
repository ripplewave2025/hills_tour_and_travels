...
Package slider, it is not optimized for mobile. Please optimize it for mobile and make the text of the Place and details very clean and less words.

Also put book packages in every slide. (Book this One or I want this)Whichever is great.
...
1. this design is for the full site, need to customize it for hillstourandtravels.com
2. need to also optimize it for mobile
3. make sure that texts stays perfectly
4. full screen and swipable would be nice.

5. EG, In once Screen Put lamahatta Picture.
Text Should be Lamahatta and then when clicked see packages, It should Include Lamahatta+Takdah+Tinchulay as well (the package already curated with book now CTA)
