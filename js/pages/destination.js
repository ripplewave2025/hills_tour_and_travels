                        ...
                        <div style="padding: 28px; display: flex; flex-direction: column; gap: 20px; flex-grow: 1; ${pkg.isComingSoon ? 'opacity: 0.85;' : ''}">
                          ...
                          <div style="border-top: 1px solid var(--glass-border); padding-top: 20px; margin-top: auto; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
                            ${pkg.isComingSoon ? `
                              ...
                              <a href="https://wa.me/919907219843?text=${encodeURIComponent('Hi! I\'m interested in the upcoming \"' + pkg.name + '\" tour for ' + dest.name + '. Could you share pricing and availability?')}" target="_blank" class="btn btn-primary" style="padding: 10px 24px; background: linear-gradient(135deg, #25d366, #128c7e);">
