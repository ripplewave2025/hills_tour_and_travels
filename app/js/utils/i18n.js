...
const DICT = {
  ...
  'nav.places':      { en: 'Places',        hi: 'स्थान',             bn: 'স্থান',           ne: 'स्थानहरू',            zh: '地点',     th: 'สถานที่' },
  'nav.darjeeling':  { en: 'Darjeeling Spots', hi: 'दार्जिलिंग स्थल', bn: 'দার্জিলিং স্পট', ne: 'दार्जिलिङ स्थलहरू',  zh: '大吉岭景点', th: 'จุดเที่ยวดาร์จีลิง' },
  'nav.experiences': { en: 'Experiences',   hi: 'अनुभव',            bn: 'অভিজ্ঞতা',       ne: 'अनुभवहरू',           zh: '体验',     th: 'ประสบการณ์' },
  'nav.pickupDropoff': { en: 'Pickup/Drop-off', hi: 'पिकअप/ड्रॉप', bn: 'পিকআপ/ড্রপ', ne: 'पिकअप/ड्रप', zh: '接送点', th: 'รับ/ส่ง' },
  'nav.about':       { en: 'About',         hi: 'हमारे बारे में',     bn: 'আমাদের সম্পর্কে', ne: 'हाम्रोबारे',          zh: '关于我们', th: 'เกี่ยวกับเรา' },
  'nav.fleet':       { en: 'Fleet & Safety', hi: 'वाहन और सुरक्षा', bn: 'গাড়িবহর ও নিরাপত্তা', ne: 'गाडी र सुरक्षा', zh: '车队与安全', th: 'ฟลีตรถและความปลอดภัย' },
